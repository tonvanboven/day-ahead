...
* zet de volgende instellingen op "standaard":
  ...
  * battery, preload next interval controls: true
  * dashboard, port: 5000
* laat de rest "blanko" 
...
Met de optie `battery -> preload next interval controls` kan DAO de berekende instellingen voor het volgende interval alvast bewaren in een JSON-bestand. Bij het begin van dat volgende kwartier of uur kan DAO dan, nog voordat de nieuwe optimalisatie klaar is, alvast de berekende aansturing zetten voor:
